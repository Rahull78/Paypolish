    ...
    public class MasterDataAccess
    {
        ...
        public List<MasterModel> GetMasterData(out bool status) 
        {
            ...
            try
            {
                ...
                string Query = "select public.spgetmaster('ref1');FETCH ALL IN \"ref1\";";
        ...
        public bool AddMasterData(MasterModel data, out bool status)
        {
            ...
            {
                DataSet dt = new DataSet();
                string Query = @$"select public.spaddmaster('{data.Date}','{data.Recieve}','{data.Issue}','{data.Pick}','{data.Touch}','{data.Loss}','{data.Fine}');";
        ...
        public bool EditMasterData(MasterModel data, out bool status)
        {
            ...
            {
                DataSet dt = new DataSet();
                string Query = @$"select public.spupdatemaster('{data.ID}','{data.Date}','{data.Recieve}','{data.Issue}','{data.Pick}','{data.Touch}','{data.Loss}','{data.Fine}');";
        ...
        public bool DeleteMasterData(MasterModel data, out bool status)
        {
            ...
            {
                DataSet dt = new DataSet();
                string Query = @$"select public.spdeletemaster('{data.ID}');";
        ...
        public List<MasterModel> FilterMasterData(DateModel data, out bool status)
        {
            ...
            try
            {
                ...
                DataSet dt = new DataSet();
                string Query = @$"select public.spgetdatabymonthmaster('{data.Current}','{data.Previous}','ref1');FETCH ALL IN ""ref1"";";
        ...
        public List<MasterModel> FilterMasterByDate(DateModel data, out bool status)
        {
            ...
            try
            {
                ...
                DataSet dt = new DataSet();
                string Query = @$"select public.spgetbydatemaster('{current}','ref1');FETCH ALL IN ""ref1"";";
